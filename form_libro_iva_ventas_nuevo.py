...
class Ui_form_libro_iva_ventas_nuevo(object):
    def setupUi(self, form_libro_iva_ventas_nuevo):
        ...
        form_libro_iva_ventas_nuevo.resize(663, 515)
        form_libro_iva_ventas_nuevo.setMinimumSize(QtCore.QSize(663, 515))
        form_libro_iva_ventas_nuevo.setMaximumSize(QtCore.QSize(663, 515))
        form_libro_iva_ventas_nuevo.setStyleSheet("font: 10pt \"Liberation Sans\";\n"
"color: rgb(0, 0, 0);\n"
...
"color: rgb(0, 0, 0);")
        ...
        self.line = QtWidgets.QFrame(form_libro_iva_ventas_nuevo)
        ...
        self.line_2 = QtWidgets.QFrame(form_libro_iva_ventas_nuevo)
        ...
        self.pushButton_2.setMinimumSize(QtCore.QSize(650, 25))
        self.pushButton_2.setMaximumSize(QtCore.QSize(650, 25))
        self.pushButton_2.setStyleSheet("background-color: rgb(119, 149, 177);")
...
"color: rgb(0, 0, 0);")
        ...
        self.verticalLayout_2.addWidget(self.dte_fec_nuevo)
        ...
        self.verticalLayout_2.addWidget(self.lne_comprbante)
        self.cbx_tipo = QtWidgets.QComboBox(self.tab)
        self.cbx_tipo.setMinimumSize(QtCore.QSize(110, 25))
        self.cbx_tipo.setMaximumSize(QtCore.QSize(110, 25))
        ...
        self.cbx_tipo.addItem("")
        self.cbx_tipo.addItem("")
        self.verticalLayout_2.addWidget(self.cbx_tipo)
        self.cbx_proveedor = QtWidgets.QComboBox(self.tab)
        self.cbx_proveedor.setMinimumSize(QtCore.QSize(200, 25))
        self.cbx_proveedor.setMaximumSize(QtCore.QSize(200, 25))
        self.cbx_proveedor.setObjectName("cbx_proveedor")
        self.verticalLayout_2.addWidget(self.cbx_proveedor)
...
"color: rgb(0, 0, 0);")
        ...
        form_libro_iva_ventas_nuevo.setTabOrder(self.lne_comprbante, self.cbx_tipo)
        form_libro_iva_ventas_nuevo.setTabOrder(self.cbx_tipo, self.cbx_proveedor)
        form_libro_iva_ventas_nuevo.setTabOrder(self.cbx_proveedor, self.cbx_mes)
        form_libro_iva_ventas_nuevo.setTabOrder(self.cbx_mes, self.lne_ref)
        form_libro_iva_ventas_nuevo.setTabOrder(self.lne_ref, self.lne_10_5)
    ...
    def retranslateUi(self, form_libro_iva_ventas_nuevo):
        ...
        self.label_2.setText(_translate("form_libro_iva_ventas_nuevo", "Cliente:"))
        self.dte_fec_nuevo.setDisplayFormat(_translate("form_libro_iva_ventas_nuevo", "dd/MM/yyyy"))
        self.lne_comprbante.setText(_translate("form_libro_iva_ventas_nuevo", "0"))
        ...
        self.label_22.setText(_translate("form_libro_iva_ventas_nuevo", "Mes:"))
        self.cbx_mes.setItemText(0, _translate("form_libro_iva_ventas_nuevo", "Enero"))
        self.cbx_mes.setItemText(1, _translate("form_libro_iva_ventas_nuevo", "Febrero"))
        self.cbx_mes.setItemText(2, _translate("form_libro_iva_ventas_nuevo", "Marzo"))
        self.cbx_mes.setItemText(3, _translate("form_libro_iva_ventas_nuevo", "Abril"))
        self.cbx_mes.setItemText(4, _translate("form_libro_iva_ventas_nuevo", "Mayo"))
        self.cbx_mes.setItemText(5, _translate("form_libro_iva_ventas_nuevo", "Junio"))
        self.cbx_mes.setItemText(6, _translate("form_libro_iva_ventas_nuevo", "Julio"))
        self.cbx_mes.setItemText(7, _translate("form_libro_iva_ventas_nuevo", "Agosto"))
        self.cbx_mes.setItemText(8, _translate("form_libro_iva_ventas_nuevo", "Septiembre"))
        self.cbx_mes.setItemText(9, _translate("form_libro_iva_ventas_nuevo", "Octubre"))
        self.cbx_mes.setItemText(10, _translate("form_libro_iva_ventas_nuevo", "Noviembre"))
        self.cbx_mes.setItemText(11, _translate("form_libro_iva_ventas_nuevo", "Diciembre"))
        self.label_7.setText(_translate("form_libro_iva_ventas_nuevo", "Ref."))
        self.lne_ref.setText(_translate("form_libro_iva_ventas_nuevo", "0"))
        ...
        self.lne_10_5.setText(_translate("form_libro_iva_ventas_nuevo", "0"))
        self.label_10.setText(_translate("form_libro_iva_ventas_nuevo", "21 %"))
        self.lne_21.setText(_translate("form_libro_iva_ventas_nuevo", "0"))
        self.label_12.setText(_translate("form_libro_iva_ventas_nuevo", "Monotributo:"))
        self.lne_monotrib.setText(_translate("form_libro_iva_ventas_nuevo", "0"))
        self.label_15.setText(_translate("form_libro_iva_ventas_nuevo", "No Gravado / Exento"))
        self.lne_no_grav.setText(_translate("form_libro_iva_ventas_nuevo", "0"))
        self.label_16.setText(_translate("form_libro_iva_ventas_nuevo", "Percepción / IIBB"))
        self.lne_iibb.setText(_translate("form_libro_iva_ventas_nuevo", "0"))
        self.label_11.setText(_translate("form_libro_iva_ventas_nuevo", "27% "))
        self.lne_27.setText(_translate("form_libro_iva_ventas_nuevo", "0"))
        self.label_13.setText(_translate("form_libro_iva_ventas_nuevo", "IVA"))
        self.lne_iva.setText(_translate("form_libro_iva_ventas_nuevo", "0"))
        self.label_14.setText(_translate("form_libro_iva_ventas_nuevo", "Otros Impuestos "))
        self.lne_otros.setText(_translate("form_libro_iva_ventas_nuevo", "0"))
        self.label_17.setText(_translate("form_libro_iva_ventas_nuevo", "Percepción IVA"))
        self.lne_percepcion_iva.setText(_translate("form_libro_iva_ventas_nuevo", "0"))
        self.label_18.setText(_translate("form_libro_iva_ventas_nuevo", "Resultado "))
        self.lne_resultado.setText(_translate("form_libro_iva_ventas_nuevo", "0"))
