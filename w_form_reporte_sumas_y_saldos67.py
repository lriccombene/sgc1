    ...
    def imprimir(self):
        ...
        for item in lista_SUMAS_SALDOS:
            ...
            for item2 in centena_padre:
                ...
                for item3 in mil_padre:
                    ...
                    for item4 in  diezmil_padre:
                        ...
                        if bandera_diezmil== True:
                            ...
                            estilodebe4 =  "<font size=6>" + str("-") + " </font>"
                            estilohaber4 =  "<font size=6>" + str("-") + " </font>"
                            estilosaldo4 = "<font size=6>" + str(total_resultado) + " </font>"
                    ...
                    if bandera_mil== True:
                        ...
                        estilosaldo3 = "<font size=6>" + str(total_resultado) + " </font>"
                ...
                if bandera_centena== True:
                    ...
                    estilodebe =  "<font size=6>" + str(resultado[0]) + " </font>"
                    estilohaber =  "<font size=6>" + str(resultado[1]) + " </font>"
                    estilosaldo = "<font size=6>" + str(total_resultado) + " </font>"
        ...
        resultado = [[Paragraph('''<b> </b>''', styleSheet["BodyText"])],
                     [Paragraph(' <b> RESULTADO DEL EJERCICIO : </b> ', estilo_resultado),
                      Paragraph('<b> </b> '""+ str(total_resultado), estilo_resultado2),
                      Paragraph('<b> </b> '""+ str(total_saldo_deudor), estilo_resultado2),
                      Paragraph('<b> </b> '""+ str(total_saldo_acreedor), estilo_resultado2)]]
